      ...
      <section className="py-24 bg-bg-surface relative overflow-hidden flex-grow flex items-center justify-center">
        ...
        <div className="max-w-4xl w-full mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16 w-full text-left">
            {/* Refund Policy Card */}
            <div className="border border-border-subtle bg-bg-primary/75 p-6 sm:p-8 relative rounded-sm group hover:border-gym-gold hover:-translate-y-1 transition-all duration-300 shadow-xl">
